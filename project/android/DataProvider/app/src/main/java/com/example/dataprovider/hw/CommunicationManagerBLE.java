...
final class CommunicationManagerBLE extends BluetoothGattCallback  {
    ...
    private final PipeDataConsumer receiveCallback;

    public CommunicationManagerBLE(Context context, PipeDataConsumer receiveCallback) {
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        ...
        if (data != null && data.length > 0) {
            receiveCallback.onDataReceived(data, 0, data.length, null);
        }
    }
