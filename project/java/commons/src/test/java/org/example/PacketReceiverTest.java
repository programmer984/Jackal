...
import static org.example.ByteUtils.searchSequense;
...
public class PacketReceiverTest {
    ...
    public void oneCorrectPacket() throws Exception {
        packetsReceiver.onNewDataReceived(PACKET_1, 0, onePacketSize);
    ...
    public void halfAndHalf() throws Exception {
        ...
        packetsReceiver.onNewDataReceived(PACKET_1, 5, onePacketSize - 5);
        Assert.assertEquals(packetsReceived, 1);
    }
    ...
    public void byteByByte() throws Exception {
        ...
        for (int i = 0; i < onePacketSize; i++) {
            packetsReceiver.onNewDataReceived(PACKET_1, i, 1);
        }
    ...
    public void oneIncorrect() throws Exception {
        packetsReceiver.onNewDataReceived(PACKET_1_INCORRECT, 0, onePacketSize);
    ...
    public void twoPackets() throws Exception {
        ...
        packetsReceiver.onNewDataReceived(PACKET_2, oneAndHalfSize, halfSize);
        Assert.assertEquals(packetsReceived, 2);
    }

    @Test
    public void zeroesThenPacket() throws Exception {
        packetsReceiver.onNewDataReceived(PACKET_000_1, 0, PACKET_000_1.length);
        Assert.assertEquals(packetsReceived, 1);
    }
    ...
    public void timeout2() throws Exception {
        ...
        Thread.sleep(100);
        packetsReceiver.onNewDataReceived(PACKET_1, headerSize, onePacketSize - headerSize);
        Assert.assertEquals(packetsReceived, 0);
    }
    ...
    private OnePacketConsumer packetConsumer = new OnePacketConsumer() {
        @Override
