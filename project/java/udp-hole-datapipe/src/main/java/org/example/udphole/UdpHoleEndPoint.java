...
public class UdpHoleEndPoint implements OutgoingPacketCarrier, PipeDataConsumer {
    ...
    public UdpHoleEndPoint(DataPipe dataPipe, IncomingPacketAcceptor consumer, TimersManager timersManager) {
        this.dataPipe = dataPipe;
        this.consumer = consumer;
        this.timersManager = timersManager;
        dataPipe.setIncomingDataConsumer(this);
        outgoingLogic = new OutgoingLogic(dataPipe, true);
